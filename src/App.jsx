...
function PrivateRoute({ children }) {
  ...
  if (loading) return <div className="h-screen flex items-center justify-center bg-gray-50 dark:bg-slate-950 text-gray-500">Carregando...</div>
...
function Navigation() {
  ...
  // Layout Simétrico: 3 Esq | Foco | 3 Dir
  return (
